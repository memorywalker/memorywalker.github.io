...
其中215-217是TCP握手过程，220-221对应于查询和应答，223-226为断开连接

#### TCP 三次握手

![mss](/uploads/wireshark/handshaketcp.png)

上面的抓包中，

215号包客户端102发起连接SYN，seq为0 (X)

216号包服务器114向客户端发SYN，应答ack=1,自己的序号seq为0 (Y)

217号包客户端102向服务端应答ACK，seq为1(X+1)，ack为1(Y+1)
